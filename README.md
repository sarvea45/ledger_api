...
This project is a high-integrity financial ledger API built with **FastAPI** and **PostgreSQL**. It implements strict double-entry bookkeeping, ACID-compliant transactions, and row-level locking to ensure data consistency in concurrent environments.
...
* **Math Integrity**: Final audit confirmed the total system balance remained consistent with zero leakage.
---
